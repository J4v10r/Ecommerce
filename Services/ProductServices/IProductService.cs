...
namespace Saas.Services.ProductServices
{
    public interface IProductService{
        Task AddProductAsync(ProductCreateDto productCreateDto, ClaimsPrincipal tenant);
        Task<bool> DeleProductByIdAsync(int id, ClaimsPrincipal user);
        ...
        Task<IEnumerable<ProductResponseDto>> GetProductsByCatalogIdAsync(ClaimsPrincipal user);
    }
}
